...
function App() {
  ...
  /* 
  Step 1 : App 컴포넌트가 렌더링되면 아래 2개의 함수를 호출하여
    변환된 값으로 설정된다. 매개변수로는 스테이트가 인수로 전달된다.
  ...
  */
  ...
  /* 
  Step 2 : 시간이 많이 걸리는 함수를 호출한 후 반환되는 값을 useMemo를
  ...
  */
  ...
  return (
    <div>
      {/* input 상자의 스핀박스를 누를때마다 핸들러에서 각 setter함수를
