...
function App() {
  ...
  const [playerData, setPlayerData] = useState([
    {idx: 1, name: '루피', score: 10},
    {idx: 2, name: '조로', score: 20},
    {idx: 3, name: '상디', score: 30},
    {idx: 4, name: '쵸파', score: 40},
  ]);
  ...
  const deletePlayerProcess = (playerIdx) => {
    ...
    //방법1 : 삭제하려는 일변번호와 일치하지 않는 데이터만 모아서 업데이트
    // let newPlayerData = [];
  ...
  return (
    <div className="scoreboard">
      ...
      {
        // map함수를 통해 인원수만큼 반복해서 Player 컴포넌트 렌더링
